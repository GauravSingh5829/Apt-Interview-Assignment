...
const CUSTOMERS = [
  ...
  "Gaurav Kumar", "Divya Nair",  "Arjun Bose",
  "Pooja Rao",
];
...
async function main() {
  ...
  if (shouldReset) {
    await setupClient.query("TRUNCATE orders RESTART IDENTITY;");
    console.log("🧹  [DB] Database reset! Truncated `orders` table back to 0 items.");
  }
